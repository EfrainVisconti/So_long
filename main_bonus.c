...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/04 16:50:07 by eviscont          #+#    #+#             */
/*   Updated: 2024/03/05 12:24:56 by eviscont         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	game_init(t_game *game)
{
	...
	game->imgs[10], game->map.player.x * PX, game->map.player.y * PX);
	mlx_loop_hook(game->mlx, put_animation, game);
